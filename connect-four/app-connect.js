document.addEventListener('DOMContentLoaded', () => {
    const squares = document.querySelectorAll('.section-gameUI__content div');
    console.log(squares);
    ...
    for (var i = 0, len = squares.length; i < len; i++ ) {
        ...
        (function(index) {
            ...
            squares[i].onclick = function() {
                // if the squre below your current square is taken, you can go ontop of it
        ...
        function checkBoard() {
            const winningArrays = [
                ...
                // take 4 values in each winningArrays and plug them into the square
